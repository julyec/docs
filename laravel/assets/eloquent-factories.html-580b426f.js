import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as c,c as d,b as a,d as e,e as s,a as n}from"./app-8cdff07c.js";const i={},p=n(`<h1 id="eloquent-数据工厂" tabindex="-1"><a class="header-anchor" href="#eloquent-数据工厂" aria-hidden="true">#</a> Eloquent：数据工厂</h1><ul><li><a href="#introduction">介绍</a></li><li><a href="#defining-model-factories">定义模型工厂</a><ul><li><a href="#generating-factories">生成工厂</a></li><li><a href="#factory-states">工厂状态</a></li><li><a href="#factory-callbacks">工厂回调</a></li></ul></li><li><a href="#creating-models-using-factories">使用工厂创建模型</a><ul><li><a href="#instantiating-models">实例化模型</a></li><li><a href="#persisting-models">持久化模型</a></li><li><a href="#sequences">序列</a></li></ul></li><li><a href="#factory-relationships">工厂关联</a><ul><li><a href="#has-many-relationships">一对多关系</a></li><li><a href="#belongs-to-relationships">属于关系</a></li><li><a href="#many-to-many-relationships">多对多关系</a></li><li><a href="#polymorphic-relationships">多态关系</a></li><li><a href="#defining-relationships-within-factories">在工厂中定义关系</a></li><li><a href="#recycling-an-existing-model-for-relationships">重复利用现有的模型建立关系</a></li></ul></li></ul><p><a name="introduction"></a></p><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><p>当测试你的应用程序或向数据库填充数据时，你可能需要插入一些记录到数据库中。Laravel 允许你使用模型工厂为每个 <a href="./eloquent">Eloquent 模型</a>定义一组默认属性，而不是手动指定每个列的值。</p><p>要查看如何编写工厂的示例，请查看你的应用程序中的 <code>database/factories/UserFactory.php</code> 文件。这个工厂已经包含在所有新的 Laravel 应用程序中，并包含以下工厂定义：</p><pre><code>namespace Database\\Factories;
