import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as t,c as a,a as n}from"./app-06635a3b.js";const o={},s=n(`<h1 id="控制台测试" tabindex="-1"><a class="header-anchor" href="#控制台测试" aria-hidden="true">#</a> 控制台测试</h1><ul><li><a href="#introduction">介绍</a></li><li><a href="#success-failure-expectations">期望成功/失败</a></li><li><a href="#input-output-expectations">期望输入/输出</a></li></ul><p><a name="introduction"></a></p><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><p>除了简化 HTTP 测试之外，Laravel 还提供了一个简单的 API 来测试应用程序的 <a href="./artisan">自定义控制台命令</a>。</p><p><a name="success-failure-expectations"></a></p><h2 id="期望成功-失败" tabindex="-1"><a class="header-anchor" href="#期望成功-失败" aria-hidden="true">#</a> 期望成功/失败</h2><p>首先，让我们探索如何对 Artisan 命令的退出代码进行断言。为此，我们将使用 <code>artisan</code> 方法从我们的测试中调用 Artisan 命令。然后，我们将使用 <code>assertExitCode</code> 方法断言该命令以给定的退出代码完成：</p><pre><code>/**
 * 测试控制台命令。
 */
