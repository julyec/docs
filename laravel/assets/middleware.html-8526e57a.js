import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,a as t}from"./app-8cdff07c.js";const d={},r=t(`<h1 id="中间件" tabindex="-1"><a class="header-anchor" href="#中间件" aria-hidden="true">#</a> 中间件</h1><ul><li><a href="#introduction">介绍</a></li><li><a href="#defining-middleware">定义中间件</a></li><li><a href="#registering-middleware">注册中间件</a><ul><li><a href="#global-middleware">全局中间件</a></li><li><a href="#assigning-middleware-to-routes">将中间件分配给路由</a></li><li><a href="#middleware-groups">中间件组</a></li><li><a href="#sorting-middleware">排序中间件</a></li></ul></li><li><a href="#middleware-parameters">中间件参数</a></li><li><a href="#terminable-middleware">可终止的中间件</a></li></ul><p><a name="introduction"></a></p><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><p>中间件提供了一种方便的机制来检查和过滤进入应用程序的 HTTP 请求。例如，Laravel 包含一个中间件，用于验证应用程序的用户是否经过身份验证。如果用户未通过身份验证，中间件会将用户重定向到应用程序的登录屏幕。 但是，如果用户通过了身份验证，中间件将允许请求进一步进入应用程序。</p><p>除了身份验证之外，还可以编写其他中间件来执行各种任务。例如，日志中间件可能会将所有传入请求记录到你的应用程序。Laravel 框架中包含了几个中间件，包括用于身份验证和 CSRF 保护的中间件。所有这些中间件都位于 <code>app/Http/Middleware</code> 目录中。</p><p><a name="defining-middleware"></a></p><h2 id="定义中间件" tabindex="-1"><a class="header-anchor" href="#定义中间件" aria-hidden="true">#</a> 定义中间件</h2><p>要创建新的中间件，请使用 <code>make:middleware</code> Artisan 命令：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>php artisan make:middleware EnsureTokenIsValid
