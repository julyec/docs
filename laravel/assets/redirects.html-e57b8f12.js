import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as t,a}from"./app-8cdff07c.js";const o={},s=a(`<h1 id="路由重定向" tabindex="-1"><a class="header-anchor" href="#路由重定向" aria-hidden="true">#</a> 路由重定向</h1><ul><li><a href="#creating-redirects">创建重定向</a></li><li><a href="#redirecting-named-routes">重定向到命名路由</a></li><li><a href="#redirecting-controller-actions">重定向到控制器动作</a></li><li><a href="#redirecting-with-flashed-session-data">使用闪存会话数据重定向</a></li></ul><p><a name="creating-redirects"></a></p><h2 id="creating-redirects" tabindex="-1"><a class="header-anchor" href="#creating-redirects" aria-hidden="true">#</a> Creating Redirects</h2><p>重定向响应是类 <code>Illuminate\\Http\\RedirectResponse</code> 的实例, 包含了重定向用户到其他 URL 所需要的合适头信息。 有很多方式生成 <code>RedirectResponse</code> 实例.。最简单的方法是使用全局的 <code>redirect</code> 辅助函数：</p><pre><code>Route::get(&#39;/dashboard&#39;, function () {
