import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as n,o as c,c as d,b as a,d as e,e as r,a as i}from"./app-06635a3b.js";const s={},l=i('<h1 id="socialite-社会化登录" tabindex="-1"><a class="header-anchor" href="#socialite-社会化登录" aria-hidden="true">#</a> Socialite 社会化登录</h1><ul><li><a href="#introduction">简介</a></li><li><a href="#installation">安装</a></li><li><a href="#upgrading-socialite">升级</a></li><li><a href="#configuration">配置</a></li><li><a href="#authentication">认证</a><ul><li><a href="#routing">路由</a></li><li><a href="#authentication-and-storage">身份验证和存储</a></li><li><a href="#access-scopes">访问范围</a></li><li><a href="#optional-parameters">可选参数</a></li></ul></li><li><a href="#retrieving-user-details">检索用户详细信息</a></li></ul><p><a name="introduction"></a></p><h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2>',4),h={href:"https://github.com/laravel/socialite",target:"_blank",rel:"noopener noreferrer"},u={href:"https://socialiteproviders.com/",target:"_blank",rel:"noopener noreferrer"},p=i(`<p><a name="installation"></a></p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><p>在开始使用 Socialite 之前，通过 Composer 软件包管理器将软件包添加到项目的依赖项中:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">composer</span> require laravel/socialite
