import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as s,a}from"./app-06635a3b.js";const t={},o=a(`<h1 id="eloquent-api-resources" tabindex="-1"><a class="header-anchor" href="#eloquent-api-resources" aria-hidden="true">#</a> Eloquent: API Resources</h1><ul><li><a href="#introduction">简介</a></li><li><a href="#generating-resources">生成资源</a></li><li><a href="#concept-overview">生成资源</a><ul><li><a href="#resource-collections">资源集合</a></li></ul></li><li><a href="#writing-resources">编写资源</a><ul><li><a href="#data-wrapping">数据包裹</a></li><li><a href="#pagination">分页</a></li><li><a href="#conditional-attributes">条件属性</a></li><li><a href="#conditional-relationships">条件关系</a></li><li><a href="#adding-meta-data">添加元数据</a></li></ul></li><li><a href="#resource-responses">资源响应</a></li></ul><p><a name="introduction"></a></p><h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2><p>在构建 API 时，你往往需要一个转换层来联结你的 Eloquent 模型和实际返回给用户的 JSON 响应。比如，你可能希望显示部分用户属性而不是全部，或者你可能希望在模型的 JSON 中包括某些关系。Eloquent 的资源类能够让你以更直观简便的方式将模型和模型集合转化成 JSON。</p><p>当然，你可以始终使用 Eloquent 模型或集合的 <code>toJson</code> 方法将其转换为 JSON ；但是，Eloquent 的资源提供了对模型及其关系的 JSON 序列化更加精细和更加健壮的控制。</p><p><a name="generating-resources"></a></p><h2 id="生成资源" tabindex="-1"><a class="header-anchor" href="#生成资源" aria-hidden="true">#</a> 生成资源</h2><p>你可以使用 <code>make:resource</code> artisan 命令来生成一个资源类。默认情况下，资源将放在应用程序的 <code>app/Http/Resources</code> 目录下。资源继承自 <code>Illuminate\\Http\\Resources\\Json\\JsonResource</code> 类：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>php artisan make:resource UserResource
