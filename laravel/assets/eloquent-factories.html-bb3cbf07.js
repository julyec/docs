import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as r,c as i,b as t,d as e,e as c,a}from"./app-06635a3b.js";const d={},l=a(`<h1 id="eloquent-factories" tabindex="-1"><a class="header-anchor" href="#eloquent-factories" aria-hidden="true">#</a> Eloquent: Factories</h1><ul><li><a href="#introduction">Introduction</a></li><li><a href="#defining-model-factories">Defining Model Factories</a><ul><li><a href="#generating-factories">Generating Factories</a></li><li><a href="#factory-states">Factory States</a></li><li><a href="#factory-callbacks">Factory Callbacks</a></li></ul></li><li><a href="#creating-models-using-factories">Creating Models Using Factories</a><ul><li><a href="#instantiating-models">Instantiating Models</a></li><li><a href="#persisting-models">Persisting Models</a></li><li><a href="#sequences">Sequences</a></li></ul></li><li><a href="#factory-relationships">Factory Relationships</a><ul><li><a href="#has-many-relationships">Has Many Relationships</a></li><li><a href="#belongs-to-relationships">Belongs To Relationships</a></li><li><a href="#many-to-many-relationships">Many To Many Relationships</a></li><li><a href="#polymorphic-relationships">Polymorphic Relationships</a></li><li><a href="#defining-relationships-within-factories">Defining Relationships Within Factories</a></li><li><a href="#recycling-an-existing-model-for-relationships">Recycling An Existing Model For Relationships</a></li></ul></li></ul><p><a name="introduction"></a></p><h2 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction" aria-hidden="true">#</a> Introduction</h2><p>When testing your application or seeding your database, you may need to insert a few records into your database. Instead of manually specifying the value of each column, Laravel allows you to define a set of default attributes for each of your <a href="./eloquent">Eloquent models</a> using model factories.</p><p>To see an example of how to write a factory, take a look at the <code>database/factories/UserFactory.php</code> file in your application. This factory is included with all new Laravel applications and contains the following factory definition:</p><pre><code>namespace Database\\Factories;
