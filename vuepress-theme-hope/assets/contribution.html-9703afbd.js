import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,a as d,b as s,f as l}from"./app-083c2955.js";const a={},c=s("p",null,"我们永远欢迎你对项目进行贡献! 这里是一份相关指南。",-1),o=l(`<h2 id="克隆并安装项目" tabindex="-1"><a class="header-anchor" href="#克隆并安装项目" aria-hidden="true">#</a> 克隆并安装项目</h2><p>使用 Git 克隆项目到本地，并使用 <code>pnpm</code> 进行依赖的安装。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone git@github.com:vuepress-theme-hope/vuepress-theme-hope.git

<span class="token function">pnpm</span> i
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container tip"><p class="hint-container-title">提示</p><p>如果你并未安装 pnpm，请使用下列命令安装它:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>corepack <span class="token builtin class-name">enable</span>
