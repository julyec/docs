import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,a as d,b as o,f as c}from"./app-083c2955.js";const s={},l=o("p",null,"We always welcome everyone to contribute! Here is a guide for you.",-1),t=c(`<h2 id="clone-and-install-project" tabindex="-1"><a class="header-anchor" href="#clone-and-install-project" aria-hidden="true">#</a> Clone and Install Project</h2><p>Use Git to clone the project to the local, and use <code>pnpm</code> to install dependencies.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone git@github.com:vuepress-theme-hope/vuepress-theme-hope.git

<span class="token function">pnpm</span> i
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container tip"><p class="hint-container-title">Tips</p><p>If you have not installed pnpm, please install it using the following command.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>corepack <span class="token builtin class-name">enable</span>
