import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as p}from"./app-66b20ad3.js";const t={},e=p(`<p>在一些情况下，有这种需求：</p><ul><li>A字段的值等于1，B字段和C字段隐藏</li><li>A字段的值等于2，B字段隐藏，C字段显示</li><li>A字段的值等于3，C字段隐藏，B字段显示</li><li>A字段的值等于4，B字段和C字段显示</li></ul><p>在或者，某些情况下，改变某字段的 label、value 等，我们称之为字段交互控制</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 省略其他示例代码</span>
