import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as e,a as s}from"./app-66b20ad3.js";const d={},l=s(`<h1 id="文件结构" tabindex="-1"><a class="header-anchor" href="#文件结构" aria-hidden="true">#</a> 文件结构</h1><h2 id="后端" tabindex="-1"><a class="header-anchor" href="#后端" aria-hidden="true">#</a> 后端</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">.</span>     
├── api                                 // 应用程序对外接口目录
│   ├── InterfaceApi                    // 接口程序目录
│   │   └──v1                           // v1接口版本
│   ├── Listener                        // 接口监听事件目录
