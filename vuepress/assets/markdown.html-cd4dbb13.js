import{_ as u}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as p,c as v,d as a,a as n,b as s,w as e,e as o}from"./app-d06631bc.js";const m={},g=n("h1",{id:"markdown",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#markdown","aria-hidden":"true"},"#"),s(" Markdown")],-1),b=n("h2",{id:"custom-containers",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#custom-containers","aria-hidden":"true"},"#"),s(" Custom Containers")],-1),k=o(`<p>Usage:</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>::: <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>type</span><span class="token punctuation">&gt;</span></span> [title]
[content]
:::
...
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1);function q(A,B){const c=t("NpmBadge"),d=t("RouterLink"),r=t("CodeTabs");return p(),v("div",null,[g,a(c,{package:"@vuepress/theme-default"}),b,n("ul",null,[n("li",null,[k,n("ul",null,[h,_,w,f,n("li",null,[s("Alias of "),a(d,{to:"/reference/default-theme/components.html#codegroup"},{default:e(()=>[s("CodeGroup")]),_:1}),s(" and "),a(d,{to:"/reference/default-theme/components.html#codegroupitem"},{default:e(()=>[s("CodeGroupItem")]),_:1}),s(": "),x])])]),y]),T,a(r,{id:"129",data:[{id:"FOO"},{id:"BAR"}]},{title0:e(({value:i,isActive:l})=>[s("FOO")]),title1:e(({value:i,isActive:l})=>[s("BAR")]),tab0:e(({value:i,isActive:l})=>[O]),tab1:e(({value:i,isActive:l})=>[C]),_:1})])}const R=u(m,[["render",q],["__file","markdown.html.vue"]]);export{R as default};
