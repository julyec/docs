import{_ as u}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as p,c as v,d as a,a as n,w as e,b as s,e as c}from"./app-d06631bc.js";const m={},b=n("h1",{id:"markdown",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#markdown","aria-hidden":"true"},"#"),s(" Markdown")],-1),g=n("h2",{id:"自定义容器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#自定义容器","aria-hidden":"true"},"#"),s(" 自定义容器")],-1),k=c(`<p>使用：</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>::: <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>type</span><span class="token punctuation">&gt;</span></span> [title]
[content]
:::
...
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1);function A(C,N){const o=t("NpmBadge"),d=t("RouterLink"),r=t("CodeTabs");return p(),v("div",null,[b,a(o,{package:"@vuepress/theme-default"}),g,n("ul",null,[n("li",null,[k,n("ul",null,[h,_,f,w,n("li",null,[a(d,{to:"/zh/reference/default-theme/components.html#codegroup"},{default:e(()=>[s("CodeGroup")]),_:1}),s(" 和 "),a(d,{to:"/zh/reference/default-theme/components.html#codegroupitem"},{default:e(()=>[s("CodeGroupItem")]),_:1}),s(" 的别名： "),y])])]),x]),q,a(r,{id:"129",data:[{id:"FOO"},{id:"BAR"}]},{title0:e(({value:i,isActive:l})=>[s("FOO")]),title1:e(({value:i,isActive:l})=>[s("BAR")]),tab0:e(({value:i,isActive:l})=>[B]),tab1:e(({value:i,isActive:l})=>[O]),_:1})])}const T=u(m,[["render",A],["__file","markdown.html.vue"]]);export{T as default};
