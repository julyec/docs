import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-c17653d8.js";const t={},p=e(`<h1 id="数据表单动作" tabindex="-1"><a class="header-anchor" href="#数据表单动作" aria-hidden="true">#</a> 数据表单动作</h1><p>运行命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>php artisan admin:action
