import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as p,c as o,b as c,d as n,e as i,w as l,a as s}from"./app-98225aba.js";const u="/dcat/assets/gp8ICoYPks-adf351ef.png",d={},r=s(`<h1 id="动作基本使用" tabindex="-1"><a class="header-anchor" href="#动作基本使用" aria-hidden="true">#</a> 动作基本使用</h1><p>开发者通过 <code>Action</code> 动作类可以非常方便的开发出一个含有特定功能的操作，可以非常方便的让用户与服务器产生交互。</p><p>例如，页面上需要一个按钮，用户点击之后可以向服务器发起请求，通过弹窗展示当前登录用户的信息，那么这个功能按钮就可以用 <code>Action</code> 来开发。</p><h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h2><p>下面我们就开始开发一个用于查看登录用户信息的按钮：</p><h3 id="使用命令创建action类" tabindex="-1"><a class="header-anchor" href="#使用命令创建action类" aria-hidden="true">#</a> 使用命令创建Action类</h3><p>首先需要先创建 <code>Action</code> 类，运行命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>php artisan admin:action
