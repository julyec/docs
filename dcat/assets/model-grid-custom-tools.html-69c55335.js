import{_ as o,a as c}from"./aaMdymSxoY-c70bb216.js";import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as u,c as d,a as s,b as n,d as t,w as e,e as p}from"./app-c17653d8.js";const r={},k=p(`<h1 id="工具栏" tabindex="-1"><a class="header-anchor" href="#工具栏" aria-hidden="true">#</a> 工具栏</h1><h2 id="工具按钮" tabindex="-1"><a class="header-anchor" href="#工具按钮" aria-hidden="true">#</a> 工具按钮</h2><p>在<code>model-grid</code>的头部默认有<code>批量删除</code>和<code>刷新</code>两个操作工具，如果有更多的操作需求，系统提供了自定义工具的功能,下面的示例添加一个性别分类选择的按钮组工具。</p><h3 id="设置工具栏按钮样式" tabindex="-1"><a class="header-anchor" href="#设置工具栏按钮样式" aria-hidden="true">#</a> 设置工具栏按钮样式</h3><p>工具栏按钮默认显示<code>outline</code>模式，效果如下</p><p>用法</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token variable">$grid</span><span class="token operator">-&gt;</span><span class="token function">toolsWithOutline</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
