import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as e}from"./app-98225aba.js";const t={},p=e(`<h1 id="数据仓库" tabindex="-1"><a class="header-anchor" href="#数据仓库" aria-hidden="true">#</a> 数据仓库</h1><p>数据仓库(<code>Repository</code>)是<code>Dcat Admin</code>中对数据增删改查操作接口的具体实现，通过<code>Repository</code>的介入可以让页面的构建不再关心数据读写功能的具体实现，开发者通过实现<code>Repository</code>接口即可对数据进行读写操作。</p><blockquote><p>{tip} 当然为了方便系统也保留了直接使用 <code>Model</code> 的功能，底层会自动把<code>Model</code>转化为数据仓库实例，毕竟大多数时候直接使用 <code>Model</code> 也能满足我们的需求。</p></blockquote><p>数据表格<code>Grid</code>、数据表单<code>Form</code>、数据详情<code>Show</code>、<code>Tree</code> 等组件不再直接依赖于<code>Model</code>，而是依赖于提供更简单清晰的接口的数据仓库，下面是<code>Repository</code>的所有接口：</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
