import{_ as i}from"./MZIdO6PrwR-cc63eaeb.js";import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o as u,c as r,b as s,d as n,e as t,w as o,a}from"./app-98225aba.js";const d={},k=a(`<h1 id="工具表单" tabindex="-1"><a class="header-anchor" href="#工具表单" aria-hidden="true">#</a> 工具表单</h1><p>工具表单(<code>Dcat\\Admin\\Widgets\\Form</code>)用来构建表单和处理提交数据，可以很方便的独立处理数据，而不需要额外注册路由。</p><h3 id="基本使用" tabindex="-1"><a class="header-anchor" href="#基本使用" aria-hidden="true">#</a> 基本使用</h3><p>用命令<code>admin:form</code>来生成表单类文件：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>php artisan admin:form Setting
