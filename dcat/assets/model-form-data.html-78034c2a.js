import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o,c as p,b as s,d as n,e as i,w as c,a as l}from"./app-98225aba.js";const u={},d=s("h1",{id:"form-data-source",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#form-data-source","aria-hidden":"true"},"#"),n(" Form data source")],-1),r=s("h2",{id:"models-and-data-warehousing",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#models-and-data-warehousing","aria-hidden":"true"},"#"),n(" Models and data warehousing")],-1),k=s("code",null,"Repository",-1),m=l(`<h2 id="data-from-the-model" tabindex="-1"><a class="header-anchor" href="#data-from-the-model" aria-hidden="true">#</a> Data from the model</h2><blockquote><p>{tip} If your data comes from <code>Model</code>, then you can also use the <code>Model</code> instance directly, and the underlying layer will automatically convert <code>Model</code> into a repository instance.</p></blockquote><p>When the data source supports the model, it is sufficient to create a very simple \`Repository&#39; class.</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
