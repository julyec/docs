import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o,c,b as n,d as s,e as t,a as i}from"./app-98225aba.js";const l="/dcat/assets/8uS1kt7oAb-810a121e.png",u="/dcat/assets/UDrNU9UxfM-d4208548.png",r={},k=n("h1",{id:"chart",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#chart","aria-hidden":"true"},"#"),s(" Chart")],-1),d=n("code",null,"Dcat Admin",-1),v={href:"https://apexcharts.com/",target:"_blank",rel:"noopener noreferrer"},m=n("code",null,"Dcat\\Admin\\Widgets\\ApexCharts\\Chart",-1),b=n("h3",{id:"simple-usage",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#simple-usage","aria-hidden":"true"},"#"),s(" Simple Usage")],-1),g=n("p",null,"If you need to build a chart, you can refer to it as follows",-1),f={href:"https://apexcharts.com/",target:"_blank",rel:"noopener noreferrer"},y=i(`<div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">{</span>
        <span class="token comment">// Execute your data query logic</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>result</p><p><img src="`+l+`" alt="" loading="lazy"></p><h3 id="图表与后端api交互" tabindex="-1"><a class="header-anchor" href="#图表与后端api交互" aria-hidden="true">#</a> 图表与后端API交互</h3><p>如果你的图表需要与后端API交互，可以参考以下方式</p><blockquote><p>{tip} 为了方便阅读，这里的Example代码直接继承前面定义的<code>MyBar</code>类。</p></blockquote><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">{</span>
        <span class="token keyword">return</span> <span class="token variable">$content</span><span class="token operator">-&gt;</span><span class="token function">body</span><span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token class-name type-declaration">Row</span> <span class="token variable">$row</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            ...
            <span class="token variable">$bar</span> <span class="token operator">=</span> <span class="token class-name static-context">MyAjaxBar</span><span class="token operator">::</span><span class="token function">make</span><span class="token punctuation">(</span><span class="token variable">$id</span><span class="token punctuation">,</span> <span class="token variable">$username</span><span class="token punctuation">)</span>
                <span class="token operator">-&gt;</span><span class="token function">fetching</span><span class="token punctuation">(</span><span class="token string single-quoted-string">&#39;$(&quot;#my-box&quot;).loading()&#39;</span><span class="token punctuation">)</span> <span class="token comment">// 设置loadingresult</span>
                <span class="token operator">-&gt;</span><span class="token function">fetched</span><span class="token punctuation">(</span><span class="token string single-quoted-string">&#39;$(&quot;#my-box&quot;).loading(false)&#39;</span><span class="token punctuation">)</span> <span class="token comment">// 移除loadingresult</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>result</p><p><img src="`+u+`" alt="" loading="lazy"></p><p><a href="js"></a></p><h3 id="设置图表配置为可执行js代码" tabindex="-1"><a class="header-anchor" href="#设置图表配置为可执行js代码" aria-hidden="true">#</a> 设置图表配置为可执行JS代码</h3><p>如果你需要在图表配置加入可执行的JS代码，可参考以下方式</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token keyword">use</span> <span class="token package">use</span> Dcat\\Admin\\Support\\JavaScript<span class="token punctuation">;</span>
<span class="token keyword">use</span> <span class="token package">Dcat<span class="token punctuation">\\</span>Admin<span class="token punctuation">\\</span>Admin</span><span class="token punctuation">;</span>
<span class="token keyword">use</span> <span class="token package">Dcat<span class="token punctuation">\\</span>Admin<span class="token punctuation">\\</span>Widgets<span class="token punctuation">\\</span>ApexCharts<span class="token punctuation">\\</span>Chart</span><span class="token punctuation">;</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token operator">...</span>   
<span class="token punctuation">}</span>    
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,17);function h(w,$){const a=e("ExternalLinkIcon");return o(),c("div",null,[k,n("p",null,[d,s(" introduces the "),n("a",v,[s("apexchartsChart"),t(a)]),s(" feature, and the "),m,s(" class can help developers to render charts quickly.")]),b,g,n("blockquote",null,[n("p",null,[s("{tip} For more types of charts, please refer to "),n("a",f,[s("official apexcharts documentation"),t(a)]),s(".")])]),y])}const _=p(r,[["render",h],["__file","widgets-charts.html.vue"]]);export{_ as default};
